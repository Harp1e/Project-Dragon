...
{
    public class CameraRaycaster : MonoBehaviour    // TODO Rename as Cursor
    {
...
//        public delegate void OnMouseOverEnemy (OnMouseOverEnemy enemy); // declare new delegate type
//        public event OnMouseOverEnemy onMouseOverEnemy; // instantiate an observer set
        ...
        private void FarTooComplex ()
        {
            ...
            // Notify delegates of right mouse click
